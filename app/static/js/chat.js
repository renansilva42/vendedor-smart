...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function addUserMessage(message, timestamp = null, name = null) {
      ...
      timestampDiv.textContent = timestamp ? new Date(timestamp * 1000).toLocaleTimeString() : new Date().toLocaleTimeString();
  ...
  function startNewConversation() {
      ...
      .then(data => {
          ...
          if (data.success && data.thread_id) {
              chatContainer.dataset.threadId = data.thread_id;
